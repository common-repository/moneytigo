<?php
class WC_OvriPnfThree extends WC_Payment_Gateway
{
  /**
   * Construction of Ovri three-step payment method
   *
   * @return void
   */
  public function __construct()
  {
    ...
    $this->method_title = __('Ovri - Payment in three instalments', 'ovri');

    // Define user set variables.
    $this->title = $this->settings['title'];
    $this->instructions = $this->get_option('instructions');
    $this->method_description = __('Accept payment in three instalments! <a href="https://my.ovri.app">Open an account now !</a>', 'ovri');
...
?>
    <h3>
      <?php _e('Ovri configuration (Payment in 3 times)', 'ovri'); ?>
    </h3>
  ...
  public function init_form_fields()
  {
    ...
    $this->form_fields = array(
      'enabled' => array(
        ...
        'type' => 'checkbox',
        'label' => __('Activate payment in three instalments', 'ovri'),
      ...
      'title' => array(
        ...
        'desc_tip' => true,
        'default' => __('Credit card in three instalments', 'ovri')
      ),
      'description' => array(
